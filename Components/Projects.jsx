  ...
  return (
    <div className="container mt-5" id="project">
      ...
      <div className="row justify-content-center mt-4">
        ...
        >
          <img
            src="../src/images/rent-bike-logo-101992_101992-original.webp"
            height="250px"
        ...
        >
          <img
            src="../src/images/url-shortener.jpg"
            height="250px"
            className="card-img-top"
            alt="..."
          ></img>
      ...
      <div className="row justify-content-center mt-4">
        ...
        >
          <img
            src="../src/images/mobilestore-future.png"
            height="250px"
            className="card-img-top"
            alt="..."
          ></img>
